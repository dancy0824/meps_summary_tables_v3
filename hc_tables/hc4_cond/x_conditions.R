...
FYC   = read.xport("PUFS/h171.ssp")
cond  = read.xport("PUFS/h170.ssp")

clink1 = read.xport("PUFS/h168if1.ssp")
clink2 = read.xport("PUFS/h168if2.ssp")

RX <- read.xport('PUFS/h168a.ssp')
DV <- read.xport('PUFS/h168b.ssp')
OM <- read.xport('PUFS/h168c.ssp')
IP <- read.xport('PUFS/h168d.ssp')
ER <- read.xport('PUFS/h168e.ssp')
OP <- read.xport('PUFS/h168f.ssp')
OB <- read.xport('PUFS/h168g.ssp')  
HH <- read.xport('PUFS/h168h.ssp')
...
condevent <- full_join(cond,clink1,by=c("CONDIDX","DUPERSID"))

...
Program Name: \\programs.ahrq.local\programs\MEPS\AHRQ4_CY2\F_DSO\FC004NKK\2015\Prog\QCFREQ2.SAS

Description:  Ranks drug groups by the weighted number of acquisitions.
...
Input file:   \\derived.ahrq.local\Derived\MEPS\AHRQ4_CY2\F_DSO\FC004NKK\2015\Data\MEPSHC15\PMED08.SAS7BDAT 
              \\derived.ahrq.local\Derived\MEPS\AHRQ4_CY2\F_DSO\FC004NKK\2015\Data\MEPSHC15\RX15MUL4.SAS7BDAT
              \\source.ahrq.local\source\MEPS\HCPUFS\HC165\DATA\H165V1.SAS7BDAT  (FY person-level PUF)
              \\source.ahrq.local\source\MEPS\CONFIDENTIAL\2014\WEIGHT\FY\PERWT14F_ORIG.SAS7BDAT
...
Update History: Blaine Byars
			  ...
			  2011-06-28 Use PMED09 as input
				5/15/14 (GLF) Manually seperate LIPITOR from SIMVASTATIN groups.  
								THIS HAND EDIT MUST BE REVISED EACH YEAR
...
PROC SUMMARY DATA=PMEDS MISSING;
  ...
  ID DRUGMISS;
  VAR &WGT;
  OUTPUT OUT=RANK (KEEP=DRUG_ID1 DRUGMISS &WGT) SUM=;
RUN;
 
PROC SORT DATA=RANK; BY DRUGMISS DESCENDING &WGT; RUN;
...
PROC REPORT DATA=PMEDSUB NOWD HEADLINE MISSING;
  COLUMN RANK DRG_NAM1 &WGT=TMPV1 &WGT=TMPV2 TMPV2X &WGT &WGT=TMPV3 TMPV3X
                      UPERS1=TMPV4 WPERS1=TMPV5 UPERS2=TMPV6 WPERS2=TMPV7 UPERS WPERS RXEXP WRXEXP;
  ...
  TITLE4 "SORTED BY RANK BASED ON WEIGHTED FREQUENCY";
  TITLE5 "TOP 50";
RUN;

...
Program Name:    \\\programs.ahrq.local\programs\MEPS\AHRQ4_CY2\F_DSO\FF004ETH\Prog\SAS\QC_PCTPOP_EV.sas 
...
%let eventype = TOTPOS DVPOS RXPOS OBPOS OBPOS_DR OBPOS_OT OPPOS OPPOS_DR OPPOS_OT ERPOS IPPOS HHPOS HHPOS_A HHPOS_N OTPOS;

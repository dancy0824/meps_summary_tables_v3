 ...
 * Program Name:    \\\programs.ahrq.local\programs\MEPS\AHRQ4_CY2\F_DSO\FF004ETH\Prog\SAS\MEANEVT.sas                                                                                                
...
VAR XP YEAR TOTAL sub AGEGRPS AGEGRPS_V2 REGION MARRIED RACE SEX INSURANCE 
INSURANCE_V2 HEALTH MENTAL_HEALTH EDUCATION EMPLOYED POVERTY;
RUN;
*/

ODS LISTING CLOSE;
PROC SURVEYMEANS DATA=ALL mean stderr SUM STD sumwgt MISSING;
VAR XP;
CLUSTER VARPSU; 
STRATA VARSTR;
WEIGHT PERWTF;
DOMAIN SUB*TOTAL SUB*AGEGRPS SUB*AGEGRPS_V2 SUB*REGION SUB*MARRIED SUB*RACE 
SUB*SEX SUB*INSURANCE SUB*INSURANCE_V2 SUB*HEALTH SUB*MENTAL_HEALTH 
SUB*EDUCATION SUB*EMPLOYED SUB*POVERTY;
...
DATA OUT2 (KEEP=YEAR grp2  MEAN STDERR  levels2 WHERE=(grp2 NE " "));
...
TITLE2 "MEAN EXPENDITURE PER EVENT ($) BY 14 DEMOGRAPHIC/HEALTH/SOCIO-ECONOMIC STATUS, FOR 1996-2014";

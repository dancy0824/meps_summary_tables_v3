 ...
 * Description :    Calculate cross section estimates - TOTEXP by demo*event and compare them with V4 of R estimates for 1996-2014                                                                                                                                                                                                
...
set RESULT;
  ...
  IF VARNAME="TOTEXP" THEN DO; GRP1="EVENT"; LEVELS1="TOT";END;
  ELSE IF VARNAME="DVEXP" THEN DO; GRP1="EVENT"; LEVELS1="DVT";END;
  ELSE IF VARNAME="RXEXP" THEN DO; GRP1="EVENT"; LEVELS1="RX";END;
  ELSE IF VARNAME="OBEXP" THEN DO; GRP1="EVENT"; LEVELS1="OBV";END;  
  ELSE IF VARNAME="OBYEXP" THEN DO; GRP1="EVENT"; LEVELS1="OBD";END;    
  ELSE IF VARNAME="OBZEXP" THEN DO; GRP1="EVENT"; LEVELS1="OBO";END;    
  ELSE IF VARNAME="OPEXP" THEN DO; GRP1="EVENT"; LEVELS1="OPT";END;    
  ELSE IF VARNAME="OPYEXP" THEN DO; GRP1="EVENT"; LEVELS1="OPY";END;      
  ELSE IF VARNAME="OPZEXP" THEN DO; GRP1="EVENT"; LEVELS1="OPZ";END;    
  ELSE IF VARNAME="EREXP" THEN DO; GRP1="EVENT"; LEVELS1="ERT";END;    
  ELSE IF VARNAME="IPEXP" THEN DO; GRP1="EVENT"; LEVELS1="IPT";END;    
  ELSE IF VARNAME="HHEXP" THEN DO; GRP1="EVENT"; LEVELS1="HHT";END;    
  ELSE IF VARNAME="HHAEXP" THEN DO; GRP1="EVENT"; LEVELS1="HHA";END;    
  ELSE IF VARNAME="HHNEXP" THEN DO; GRP1="EVENT"; LEVELS1="HHN";END;    
  ELSE IF VARNAME="OTEXP" THEN DO; GRP1="EVENT"; LEVELS1="OMA";END;    
...
TITLE2 "TOTEXP (in billions) BY CROSS SECTIONAL DEMO*EVENT, FOR 1996-2014";

...
if("TABLES.Rdata" %in% list.files("../../mepstrends/hc_tables/hc1_use")){
  load("../../mepstrends/hc_tables/hc1_use/TABLES.Rdata")
...
if(length(years) == 0){
  ...
  ## Merge FYC and Event stats
    ...
    # QC
     ...
     save(use_tables, file="../../mepstrends/hc_tables/hc1_use/TABLES.Rdata")
